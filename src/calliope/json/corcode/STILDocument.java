...
public class STILDocument extends JSONObject
{
    ...
    {
        String corcode = Utils.readStringFromFile(src);
        JSONObject doc = (JSONObject)JSONValue.parse( corcode );
        ...
        {
            JSONObject subDoc = (JSONObject) list.get( i );
